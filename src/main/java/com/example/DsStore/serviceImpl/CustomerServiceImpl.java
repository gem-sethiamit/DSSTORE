...
import com.example.DsStore.exceptions.*;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    Customer customerDelete = this.customerRepo.findById(customerId).orElseThrow(()->new ResourceNotFoundException("Customer","customerId",customerId));
